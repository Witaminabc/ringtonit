...
//	wp_enqueue_style( 'rs-footer', get_stylesheet_directory_uri().'/template-parts/rs-footer/css/st-footer.css');
    wp_enqueue_style( 'rs-footer', get_stylesheet_directory_uri().'/template-parts/rs-footer/css/rs-footer.css');
    wp_enqueue_style( 'st-head-footer-change', get_stylesheet_directory_uri().'/template-parts/rs-footer/css/st-head-footer-change.css');
