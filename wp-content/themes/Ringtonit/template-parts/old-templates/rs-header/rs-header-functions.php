...
function style_rs_header_theme()
{
    ...
    wp_enqueue_style('top-header', get_stylesheet_directory_uri() . '/template-parts/rs-header/css/st-menu-head.css');
...
//	add_action('storefront_header', 'storefront_primary_navigation_logo_child', 45);
    ...
    add_action('storefront_header', 'st_contacts', 53);
    ...
    add_action('storefront_header', 'StmobileMenu', 70);
...
{ ?>
    <div class="search-full hidden-xs hidden-sm">
        <?php
        if (is_woocommerce()) {
            get_product_search_form();
        } else {
...
function StmobileMenu(){
    ?>
    <div class="stmobilemenu">
        <div class="stmobilemenu-wrap">
        <div class="closeMenu-wrap"><div class="closeMenu"></div></div>
        <ul class="nav-links stmobilemenu-menu">
            <li><a href="https://stophimiy.ru/" class="nav-link">Главная</a></li>
            <li><a href="https://stophimiy.ru/about/" class="nav-link">О нас</a></li>
            <li><a href="https://stophimiy.ru/articles/" class="nav-link">Статьи</a></li>
            <li><a href="https://stophimiy.ru/news/" class="nav-link">Новости</a></li>
            <li><a href="https://stophimiy.ru/reviews/" class="nav-link">Отзывы</a></li>
            <li><a href="https://stophimiy.ru/video/" class="nav-link">Видео</a></li>
            <li><a href="https://stophimiy.ru/links/" class="nav-link">Наши партнеры</a></li>
            <li><a href="https://stophimiy.ru/kontakty/" class="nav-link">Контакты</a></li>
        </ul>
        </div>
    </div>
<!--        --><?php
