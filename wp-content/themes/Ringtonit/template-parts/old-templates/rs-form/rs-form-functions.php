    ...
    <section class="contact-form-section">
        <div class="contact-form-section-wrap">
            <div class="form-header">
                <h2 class="form-title">Отправьте заявку и получите индивидуальные условия</h2>
            </div>
            <?php echo do_shortcode('[contact-form-7 id="2459" title="Форма стопхим"]') ?>
            <div class="form-footer">
                <div class="form-signature">
                    <span class="powered-by">Форма</span>
                    <span class="bitrix-logo">Обратной связи</span>
                </div>
            </div>
        </div>
    </section>
